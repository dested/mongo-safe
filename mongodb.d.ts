...
/** @public */
export  const AuthMechanism: Readonly<{
...
/** @public */
export  const AutoEncryptionLoggerLevel: Readonly<{
...
/** @public */
export  const BatchType: Readonly<{
  readonly INSERT: 1;
  readonly UPDATE: 2;
  readonly DELETE: 3;
}>;
...
/** @public */
export  const Compressor: Readonly<{
  readonly none: 0;
  readonly snappy: 1;
  readonly zlib: 2;
}>;
...
/** @public */
export  const CURSOR_FLAGS: readonly [
  'tailable',
  'oplogReplay',
  'noCursorTimeout',
  'awaitData',
...
export  class Db {
   ...
   * @typeParam TChange - Type of the whole change stream document emitted
   */
  watch<TSchema extends Document = Document, TChange extends Document = ChangeStreamDocument<TSchema>>(
    pipeline?: Document[],
    options?: ChangeStreamOptions
...
/** @public */
export  const ExplainVerbosity: Readonly<{
...
/** @public */
export  const GSSAPICanonicalizationValue: Readonly<{
  readonly on: true;
  readonly off: false;
  readonly none: 'none';
...
/** @public */
export  const LEGAL_TCP_SOCKET_OPTIONS: readonly ['family', 'hints', 'localAddress', 'localPort', 'lookup'];

/** @public */
export  const LEGAL_TLS_SOCKET_OPTIONS: readonly [
  'ALPNProtocols',
  'ca',
  'cert',
  'checkServerIdentity',
...
/** @public */
export  const LoggerLevel: Readonly<{
...
/** @public */
export  const MONGO_CLIENT_EVENTS: readonly [
...
/** @public */
export  const MongoErrorLabel: Readonly<{
 ...
 */
export  const ObjectID: typeof ObjectId;
...
/** @public */
export  const ProfilingLevel: Readonly<{
  readonly off: 'off';
...
/** @public */
export  const ReadConcernLevel: Readonly<{
...
/** @public */
export  const ReadPreferenceMode: Readonly<{
...
/** @public */
export  const ReturnDocument: Readonly<{
...
/** @public */
export  const ServerApiVersion: Readonly<{
  readonly v1: '1';
}>;
 ...
 * @public
 */
export  const ServerType: Readonly<{
 ...
 * @public
 */
export  const TopologyType: Readonly<{
 ...
 * @public
 */
export  interface TypedEventEmitter<Events extends EventsDescription> extends EventEmitter {
...
export type NumericTypes = number | Decimal128 | Double | Int32 | Long;
...
export type DeepQuery<T, TOverride = undefined> = {
  [key in DeepKeys<T>]?: TOverride extends undefined ? DeepKeysValue<T, key> : TOverride;
};
