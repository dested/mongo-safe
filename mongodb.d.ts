...
declare module 'mongodb' {
  ...
  export interface Collection<TSchema extends {[key: string]: any} = DefaultSchema> {
     ...
     */
    watch<T = TSchema>(pipeline?: object[], options?: ChangeStreamOptions & {session?: ClientSession}): ChangeStream<T>;
    /**
     * @param options - optional settings
     * @see http://mongodb.github.io/node-mongodb-native/3.6/api/Collection.html#watch
     */
  ...
  type DotAndArrayNotation<AssignableType> = DeepQuery<AssignableType>;
  ...
  export type MatchKeysAndValues<TSchema> = DotAndArrayNotation<TSchema>;
  ...
  export type SchemaMember<T, V> = DeepQuery<T, V>;
  ...
  export type PushOperator<TSchema> = ({
    ...
    DeepQuery<TSchema, ArrayOperator<any> | any>;
  ...
  export type PullOperator<TSchema> = ({
    ...
    NotAcceptedFields<TSchema, ReadonlyArray<any>>) &
    DeepQuery<TSchema, QuerySelector<any> | any>;
  ...
  type UpdateQueryImpl<TSchema> = {
    ...
    $rename?: DeepQuery<TSchema, string>;
    ...
    $bit?: DeepQuery<TSchema, {[key in 'and' | 'or' | 'xor']?: number}>;
  };
  ...
  export class Cursor<T = Default> extends Readable {
    ...
    sort(keyOrList: DeepKeys<T> | Array<[DeepKeys<T>, number]> | SortOptionObject<T>, direction?: number): Cursor<T>;
