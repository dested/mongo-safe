...
export interface FilterOperators<TValue, TMatchValues> extends NonObjectIdLikeDocument {
  ...
  $not?:
    | (TValue extends string ? FilterOperators<TValue, TMatchValues> | RegExp : FilterOperators<TValue, TMatchValues>)
    | TMatchValues;
  /**
